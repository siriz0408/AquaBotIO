...
const PLANS = [
  {
    ...
    name: "Free",
    price: "$0",
    description: "Basic access for casual hobbyists",
    features: ["1 tank", "10 AI messages/day", "Water parameter tracking", "Basic maintenance reminders"],
  },
  {
    id: "starter",
    name: "Starter",
    price: "$3.99",
    description: "For dedicated single-tank keepers",
    features: ["1 tank", "100 AI messages/day", "Water parameter tracking", "Priority support"],
    popular: false,
  },
  {
    id: "plus",
    name: "Plus",
    price: "$7.99",
    description: "For multi-tank enthusiasts",
    features: [
      "Up to 5 tanks",
      "200 AI messages/day",
