...
export function EmptyState({ onSuggestedPrompt, className }: EmptyStateProps) {
  return (
    <div className={cn("h-full flex flex-col items-center justify-center p-6", className)}>
      ...
      >
        <div className="w-20 h-20 bg-gradient-to-br from-brand-teal to-brand-navy rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg">
      ...
      <div className="w-full max-w-md space-y-3">
        ...
        {suggestedPrompts.map((prompt, index) => (
          <motion.button
            ...
            className="w-full bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:border-brand-teal hover:shadow-md transition-all text-left"
          >
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-brand-teal/10 to-brand-navy/10 rounded-xl flex items-center justify-center text-2xl">
                {prompt.icon}
              </div>
