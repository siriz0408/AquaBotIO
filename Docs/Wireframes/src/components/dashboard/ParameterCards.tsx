...
export function ParameterCards() {
  ...
  return (
    <div className="px-4">
      <h2 className="text-lg font-semibold text-[#0A2463] mb-3">Water Parameters</h2>
        ...
        {parameters.map((param, index) => (
          ...
          >
            ...
            <div className="flex items-baseline gap-1 mb-1">
              <span className="text-2xl font-bold text-[#0A2463]">{param.value}</span>
